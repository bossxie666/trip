...
export async function POST(request: Request, { params }: { params: Promise<{ slug: string }> }) {
  ...
  try {
    ...
    const body = await request.json() as { type?: BookingType; status?: BookingStatus; title?: string; startDateLocal?: string | null; endDateLocal?: string | null; startAt?: string | null; endAt?: string | null; place?: PlaceInput; origin?: PlaceInput; destination?: PlaceInput; totalAmountMinor?: number | null; participantMemberIds?: string[]; bookingReference?: string | null; notes?: string | null };
    const db = getDb();
