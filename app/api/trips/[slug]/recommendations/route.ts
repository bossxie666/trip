...
import { addRecommendationPlaceOption, createRecommendation } from "@/services/recommendation-repository.server";
import { createAmapPlace } from "@/services/place-repository.server";
import type { RecommendationCategory } from "@/models/planning";

const categories = new Set(["attraction", "food", "cafe", "shopping", "hotel", "experience", "other"]);
