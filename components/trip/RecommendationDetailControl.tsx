...
export function RecommendationDetailControl({ slug, recommendationId }: { slug: string; recommendationId: string }) {
  ...
  return <><button type="button" className="recommendation-detail-trigger" onClick={show}>查看详情</button><WorkspaceOverlay open={open} onClose={() => setOpen(false)} mode="modal" ariaLabel="攻略素材详情" className="recommendation-detail-drawer">
