...
export function BudgetWorkspace({ slug, budget, members, days }: { slug: string; budget: PersonalBudgetWorkspace | null; members: Member[]; days: Day[] }) {
